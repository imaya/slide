    ...
    if (tFormat === LosslessFormat.COLOR_MAPPED) {
      ...
      while (tOp < tLength) {
        ...
        for (tX = 0; tX < tWidth; ++tX) {
          ...
          if (this.withAlpha) {
            tPixelArray[tOp++] = tPalette[tIndex    ] * tTrns[tIndex / 3] / 255 | 0;
            tPixelArray[tOp++] = tPalette[tIndex + 1] * tTrns[tIndex / 3] / 255 | 0;
            tPixelArray[tOp++] = tPalette[tIndex + 2] * tTrns[tIndex / 3] / 255 | 0;
            tPixelArray[tOp++] = tTrns[tIndex / 3];
          } else {
